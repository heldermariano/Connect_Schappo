      ...
      {!isRecording && (
        <form onSubmit={handleSubmit} className="border-t border-gray-200 dark:border-gray-800 px-1.5 py-1.5 flex items-center gap-1 shrink-0 bg-white dark:bg-black">
          ...
          <button
            ...
            className="shrink-0 w-7 h-7 flex items-center justify-center rounded-full text-gray-400 hover:text-schappo-600 hover:bg-gray-100 transition-colors"
          ...
          <input
            ...
            className="flex-1 min-w-0 px-2 py-1.5 text-xs border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-1 focus:ring-schappo-500 focus:border-transparent"
          />
          ...
          {texto.trim() ? (
            <button
              type="submit"
              className="shrink-0 w-7 h-7 flex items-center justify-center rounded-full bg-schappo-500 text-white hover:bg-schappo-600 transition-colors"
              title="Enviar"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="shrink-0 w-7 h-7 flex items-center justify-center rounded-full text-gray-400 hover:text-red-500 hover:bg-gray-100 transition-colors"
              title="Gravar audio"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
