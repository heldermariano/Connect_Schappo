      ...
      <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-800">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-sm border border-gray-200 dark:border-gray-600 bg-white dark:bg-black text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-schappo-500 focus:border-transparent placeholder:text-gray-400 dark:placeholder:text-gray-500"
          />
        </div>
      </div>
