      ...
      <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
        ...
        {syncResult && (
          <div className="mb-3 px-3 py-2 bg-green-50 text-green-700 text-xs rounded-lg">
            {syncResult.processed} contatos verificados, {syncResult.updated} atualizados{syncResult.errors > 0 ? `, ${syncResult.errors} erros` : ''}.
          </div>
        )}
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-sm border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-schappo-500 focus:border-transparent placeholder:text-gray-400 dark:placeholder:text-gray-500"
          />
        </div>
      </div>
